        ...
        child: Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                const Color.fromARGB(255, 0, 82, 246).withOpacity(0.1),
                const Color.fromARGB(233, 37, 171, 255).withOpacity(0.2),
              ],
            ),
          ),
          child: SafeArea(
              ...
              children: [
                ...
                Stack(
                  ...
                  children: [
                    ...
                    Image.asset('images/aqua_bottle1.png', height: 335),
                  ],
                ),
              ],
            ),
                    ...
                    decoration: InputDecoration(
                      ...
                      border: OutlineInputBorder(
                        ...
                        borderSide: const BorderSide(
                            color: Color.fromRGBO(30, 44, 164, 1)),
                      ),
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(
            255, 255, 255, 255), // Warna latar belakang AppBar
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        const Center(
                          // Menggunakan widget Center di sini
                          child: Text(
                            'Register',
                            style: TextStyle(
                              fontSize: 24,
